  ...
  return (
    <section>
      <div className="px-[0.75rem] py-24">
        ...
        >
          <p className="opacity-70 text-lg font-semibold">Pricing Package</p>
        ...
        <div className=" pricing-cards flex flex-col gap-8 items-center mt-24">
          <motion.div
            ...
            className="pricing-card bg-[#1F1F1F] rounded-xl px-3 py-4 pb-12"
          >
            <div className=" flex flex-col gap-8 bg-[#131313] rounded-xl px-6 py-10">
              <div className="flex flex-col gap-2 ">
                ...
                <p className=" text-lg font-semibold">
                  <span className="opacity-70"> Try Out Basic Plan Save</span>
